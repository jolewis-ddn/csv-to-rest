# Update to HTTPS based on http://www.socouldanyone.com/2014/01/bottle-with-ssl.html

from bottle import Bottle, get, run, ServerAdapter, route, template, response, static_file
import csv
import json
import os.path
...
srv = SSLWSGIRefServer(host="0.0.0.0", port=9984)
run(server=srv)
